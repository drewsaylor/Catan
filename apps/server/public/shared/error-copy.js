...
function codeToCopy(code, { room = null, data = null } = {}) {
  ...
  const known = {
    ...
    NO_SUCH_OFFER: "That trade offer no longer exists.",
    ...
    NO_SETTLEMENT: "No settlement there to upgrade.",
    NOT_YOURS: "That's not yours.",
    ALREADY_CITY: "Already a city.",
    EDGE_OCCUPIED: "That spot is already taken.",
    ...
    BAD_ADMIN_SECRET: "Another TV controls this room.",
